...
let lionsDenAddress = MasterChef.address
let cub = Token.address
...
module.exports = async function (deployer, network, accounts) {
  ...
  // await deployer.deploy(MasterChef, govAddress, 21050000, Token.address)
  // await deployer.deploy(Staker, Token.address, govAddress, MasterChef.address)
  //
  // //mint 1.3M tokens
  // const tokenInstance = await Token.deployed();
  // await tokenInstance.mint(govAddress, '1300000000000000000000000', {from:accounts[0]})
  //
  // // transfer token ownership
  // await tokenInstance.transferOwnership(MasterChef.address, {from:accounts[0]})
